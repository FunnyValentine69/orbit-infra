...
| File | Purpose |
|---|---|
| [CARTOON_PROVENANCE.md](../assets/CARTOON_PROVENANCE.md) | Generator commit and digests for the cartoon, transcript, and emblem. |
| [CARTOON_TRANSCRIPT.md](../assets/CARTOON_TRANSCRIPT.md) | Text version of the animated mini-cartoon. |
...
| [emblem.svg](../assets/emblem.svg) | Animated shield-and-orbit emblem used in the README hero. |
...
| [orbit-cartoon.svg](../assets/orbit-cartoon.svg) | Animated plain-terms overview of the project's guardrails, evidence, and deployment boundary. |
