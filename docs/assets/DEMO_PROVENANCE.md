...
| generator commit | c99c164 (the tree at this commit holds every path in DEMO_GENERATOR_PATHS) |
...
| artifact | 226592 bytes, 29.840000 s, 746 frames |
| artifact sha256 | eb77cc30054a8359fa66812763e37f5d3401e2b3f2f9a3c8314845905d08521e |
...
- Frames: `ffmpeg` decoded all 746 frames of the artifact row (passthrough decode exit 0); 255 unique frames by MD5.
