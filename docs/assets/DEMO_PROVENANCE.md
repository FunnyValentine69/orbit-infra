...
| generator commit | afbd8fe (the tree at this commit holds every path in DEMO_GENERATOR_PATHS) |
...
| artifact | 228714 bytes, 30.040000 s, 751 frames |
| artifact sha256 | eb208a39aecc491866f412c2afa4e3fc9f1fe81ac070c3980ce9d622d265965b |
...
- Frames: `ffmpeg` decoded all 751 frames of the artifact row (passthrough decode exit 0); 272 unique frames by MD5.
