...
| P0-3d | Simulator evidence does not prove service enforcement, OIDC trust, or live KMS and ECR behavior. | The committed matrix retains 220 simulated cases in 65 rows, but an applied bootstrap and the remaining trust, live-call-only, not-simulatable, and service-enforcement checks in [`iam-matrix.md`](iam-matrix.md) have not run. | [`../TODO.md`](../TODO.md) |
