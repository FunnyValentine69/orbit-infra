...
| P5-21 | A digest signed after passing Trivy keeps its signature if a later scan would fail; apply verifies signature and provenance, not scan freshness. | Scan-result attestation and freshness enforcement are not implemented. | [`../TODO.md`](../TODO.md) |
