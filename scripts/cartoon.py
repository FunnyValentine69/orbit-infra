...
def animation_tracks() -> tuple[Track, ...]:
    ...
    beats: tuple[Track, ...] = (
        ...
        ("coin-1", transform, ((0, move(0, -64)), (.6, move(0, -64)), (1.45, move(12, -100)), (2.4, move(55, -67)), (28, move(55, -67)))),
        ("coin-2", opacity, ((0, 0.0), (1.35, 0.0), (1.4, 1.0), (3.15, 1.0), (3.25, 0.0), (28, 0.0))),
        ("coin-2", transform, ((0, move(0, -64)), (1.4, move(0, -64)), (2.25, move(8, -105)), (3.25, move(43, -76)), (28, move(43, -76)))),
        ("coin-3", opacity, ((0, 0.0), (2.3, 0.0), (2.35, 1.0), (4.55, 1.0), (4.7, 0.0), (28, 0.0))),
        ("coin-3", transform, ((0, move(0, -64)), (2.35, move(0, -64)), (3.35, move(15, -108)), (4.7, move(70, -82)), (28, move(70, -82)))),
