...
- [x] P3-14: stage-1 close redesign (typed outcomes, bounded tagging re-query, strict tagging/verifier response schemas, AWS CLI wrapper with timeouts, LocalStack allowances in the manifest, three-attempt retry budget) LOCALSTACK-VERIFIED (see ADR 0006, "Live-proof findings 2026-09-02"); fixture suite tests/cleanup-verifier.sh (31 cases; one recorded backend response, remaining fixtures authored)
