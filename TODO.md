...
- [ ] P5-1: `drift-check.yml` scheduled `plan -detailed-exitcode` against `bootstrap/` with the plan-reader role; accept: a dispatch run reports no drift and a deliberately modified bootstrap resource is detected — CODE-ONLY until P0-3b (needs the real bootstrap state)
...
- P5-5 through P5-11 below are real-AWS hardening items and stay CODE-ONLY until P0-3b
