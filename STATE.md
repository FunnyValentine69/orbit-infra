...
```
LOCATION   Phase 5 built: P5-2 and P5-3 merged (PRs #10-#12); P5-4 complete with the recorded demo (feat/p5-4-demo, PR number recorded when it opens); next: the P0-3b decision gate
...
NEXT       decide P0-3b (paid plan) which gates P5-1, P5-x, P5-5..P5-11, P5-22 and every CODE-ONLY item; P5-12..P5-21, P5-23..P5-26 open
```
