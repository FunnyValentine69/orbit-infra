...
output "container_definitions_json" {
  description = "The task definition's container_definitions JSON string, null when var.enabled is false"
  value       = try(aws_ecs_task_definition.this[0].container_definitions, null)
}
