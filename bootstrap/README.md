...
Run: `bootstrap/preflight.sh` (live, needs AWS credentials for profile orbit, see ../docs/RUNBOOKS.md § Local credentials),
...
and P0-3d evidence cases are in [`../docs/evidence/iam-matrix.md`](../docs/evidence/iam-matrix.md).
